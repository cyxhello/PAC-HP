...
import wandb
# wandb.init(project="medGAN_single")
...
def parseyaml():
    ...
    with open(sys.argv[1]) as ctrl_file:
        ...
        # wandb.config.update({
        #     "path": params['path'],
        #     "modelname": params['arch'],
        #     "num_epochs" : params['num_epochs'],
        #     "batch_size": params['batch_size'],
        #     "learning_rate": params['learning_rate'],
        #     "latent_vector" :params['latent_vector'],
        #     "image_size" : params['image_size'],
        #     "gen_feature_maps" : params['gen_feature_maps']
        #     })
...
def main():
    ...
    if params['arch'] == 'Generator':
        ...
        if params['image_size'] == 64:
            ...
            netG = Generator(ngpu=0, nz=64,
                             ngf=64, nc=3).to(device)
        ...
        for i in range(params['quantity']):
            ...
            fixed_noise = torch.randn(8, 64, 1, 1, device=device)
